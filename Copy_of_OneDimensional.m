...
Y_=double(subs(u,X_));
i=5;
t1=double(exp(-subs(r,X_(i)))*(subs(u,X_(i+1))-subs(u,X_(i))))
t2=double(P_h_1_i(subs(r,X_(i)),subs(a,X_(i)),e)*subs(ux,X_(i))+Q_h_1_0i(subs(r,X_(i)),subs(a,X_(i)),e)*subs(f,X_(i)))
t3=double((P_h_1_i(subs(r,X_(i)),subs(a,X_(i)),e)+P_h_2_i(subs(r,X_(i)),subs(a,X_(i)),subs(ax,X_(i)),e))*subs(ux,X_(i))+(Q_h_1_0i(subs(r,X_(i)),subs(a,X_(i)),e)+Q_h_2_0i(subs(r,X_(i)),subs(a,X_(i)),subs(ax,X_(i)),e))*subs(f,X_(i))+Q_h_2_1i(subs(r,X_(i)),subs(a,X_(i)),e)*subs(fx,X_(i)))
U0=[Y_(1),Y_(n+1)];
tic
%U=Solve2_(e,a,f,n,U0);
%U0=[0,0];
%e=1;
[U,pp,ee,Y1]=Solve1__(n,1,U0);
norm(ee)
[U,pp,ee,Y2]=Solve2__(n,1,U0);
norm(ee)
toc
norm(Y1-Y2)
plot(X_,U);
...
function [u,p,e,A2]=Solve1__(n,e,u0)
h=1/n;
x=0:h:1;
a=zeros(1,n+1);
f=zeros(1,n+1);
...
function [u,p,e,A2]=Solve2__(n,e,u0)
h=1/n;
x=0:h:1;
a=zeros(1,n+1);
ax=zeros(1,n+1);
